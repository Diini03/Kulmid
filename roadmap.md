...
## Phase 1 — Distribution & SEO
- [x] Slug-first public event URLs (`/event/:slug`) with UUID fallback + canonical redirect
- [x] `Event` JSON-LD on the in-app public event page
- [x] `sitemap.xml` generated from published/featured events
