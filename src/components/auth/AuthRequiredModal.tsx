...
export const AuthRequiredModal = ({
  isOpen,
  onClose,
  message = "Please sign in or sign up below."
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md p-8 bg-card border-border/50">
        ...
        <div className="space-y-1 mb-6">
          <h2 className="text-2xl font-semibold text-foreground">Welcome to Kulmid</h2>
        ...
        <div className="space-y-3">
          <Button 
            ...
            variant="outline" 
            className="w-full h-12 border-border/50 bg-muted/30 hover:bg-muted/50"
          >
